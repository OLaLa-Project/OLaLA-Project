...
DB_LOCK_TIMEOUT_SECONDS = float(os.getenv("DB_LOCK_TIMEOUT_SECONDS", "15"))  # 0 to disable
DB_STATEMENT_TIMEOUT_SECONDS = float(os.getenv("DB_STATEMENT_TIMEOUT_SECONDS", "0"))  # 0 to disable
DB_SYNCHRONOUS_COMMIT = os.getenv("DB_SYNCHRONOUS_COMMIT", "on")
EMBED_NDIGITS = int(os.getenv("EMBED_NDIGITS", "6"))
EMBED_STOP_FILE = os.getenv("EMBED_STOP_FILE", "")
