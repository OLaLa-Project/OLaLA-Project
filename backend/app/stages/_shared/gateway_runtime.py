"""
Gateway runtime utilities for Stage execution.

Minimal runtime to preserve LLMGateway/BaseGateway execution flow
...
class GatewayUnavailableError(GatewayError):
    """Gateway unavailable error (circuit open)."""
    pass
...
# ---------------------------------------------------------------------------
# Retry Policy (same rules as BaseGateway)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Circuit Breaker (same rules as BaseGateway)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Execute Wrapper (same flow as BaseGateway.execute)
# ---------------------------------------------------------------------------
