                    ...
                    <section className="team-stage-card">
                        ...
                        <div className="row">
                            ...
                            >
                                ...
                                <option value="stage06_verify_support">stage06_verify_support</option>
                                <option value="stage07_verify_skeptic">stage07_verify_skeptic</option>
                                <option value="stage08_aggregate">stage08_aggregate</option>
                                <option value="stage09_judge">stage09_judge</option>
                            </select>
                            <select
                                className="input"
                                value={endStage}
